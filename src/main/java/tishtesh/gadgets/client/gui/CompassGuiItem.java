...
public class CompassGuiItem extends GadgetGuiItem {
    ...
    protected void render(MatrixStack matrixStack, Minecraft minecraft, GadgetOverlayGui gui, int x, int y) {
        ...
        if (Config.CLIENT.gadgetGuiIcons.get()) {
            gui.drawTexture(matrixStack, Icons.CompassGuiIcon, x + 1, y + (getHeight() / 2) - 9,  18, 18);
            width += 18;
        }
        ...
        // Draw direction text
        minecraft.font.drawShadow(matrixStack, directionFacing, x + 1 + width / 2F - minecraft.font.width(directionFacing) / 2F,
        ...
        minecraft.font.drawShadow(matrixStack, coordinates, (x + 2 + width / 2F - minecraft.font.width(coordinates) / 2F) / GadgetOverlayGui.SmallTextSF,
